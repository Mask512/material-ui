...
export const MuiButton = () => {
  return (
    <Stack spacing={4}>
      ...
      <Stack spacing={2} direction={'row'}>
      <Button variant='contained' startIcon={<SendIcon/>} disableRipple onClick={()=> alert('clicked')}>Send (disable ripple effect)</Button>
      <Button variant='contained' endIcon={<SendIcon/>} disableElevation>Send (disable elevation)</Button>
